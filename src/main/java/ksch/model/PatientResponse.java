 ...
 */
@JsonPropertyOrder({
  PatientResponse.JSON_PROPERTY_PATIENT_NUMBER,
  PatientResponse.JSON_PROPERTY_AGE,
  PatientResponse.JSON_PROPERTY_NAME,
  PatientResponse.JSON_PROPERTY_GENDER,
  PatientResponse.JSON_PROPERTY_PATIENT_CATEGORY,
  PatientResponse.JSON_PROPERTY_PHONE_NUMBER,
  PatientResponse.JSON_PROPERTY_RESIDENTIAL_ADDRESS,
  PatientResponse.JSON_PROPERTY_ID
})
...
public class PatientResponse {
  ...
  public PatientResponse patientNumber(String patientNumber) {
  ...
  **/
  ...
  public PatientResponse age(Integer age) {
  ...
  **/
  ...
  public PatientResponse gender(Gender gender) {
  ...
  **/
  ...
  public PatientResponse patientCategory(PatientCategory patientCategory) {
  ...
  **/
  ...
  public PatientResponse phoneNumber(String phoneNumber) {
  ...
  **/
  ...
  public PatientResponse residentialAddress(String residentialAddress) {
  ...
  **/
  ...
  public PatientResponse id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this PatientResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.patientNumber, patientResponse.patientNumber) &&
        equalsNullable(this.age, patientResponse.age) &&
        equalsNullable(this.name, patientResponse.name) &&
        equalsNullable(this.gender, patientResponse.gender) &&
        equalsNullable(this.patientCategory, patientResponse.patientCategory) &&
        equalsNullable(this.phoneNumber, patientResponse.phoneNumber) &&
        equalsNullable(this.residentialAddress, patientResponse.residentialAddress) &&
        Objects.equals(this.id, patientResponse.id);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(patientNumber), hashCodeNullable(age), hashCodeNullable(name), hashCodeNullable(gender), hashCodeNullable(patientCategory), hashCodeNullable(phoneNumber), hashCodeNullable(residentialAddress), id);
  }
